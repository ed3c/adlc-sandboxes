...
> （`sandboxes/` 非 skill root，故不被動載入；可調用入口 = [`.claude/commands/fullstack-design-judge.md`](../../.claude/commands/fullstack-design-judge.md)，或直接跑下方 `judge_selftest.py` / loop kernel）。
